...
from models.non_local import NLTimeBlock
__all__ = ['i3d_resnet']
...
class I3D_ResNet_Non_Local(nn.Module):
    def __init__(self, depth, num_classes=1000, dropout=0.5, without_t_stride=False,
                 zero_init_residual=False):
        super(I3D_ResNet_Non_Local, self).__init__()
        layers = {
            18: [2, 2, 2, 2],
            34: [3, 4, 6, 3],
            50: [3, 4, 6, 3],
        ...
        self.nlb3= NLTimeBlock(in_channels=128* block.expansion,inter_channels=128* block.expansion)
    ...
    def forward(self, x):
        ...
        return logits, nlb_feature3

def i3d_resnet_non_local(depth, num_classes, dropout, without_t_stride, **kwargs):
    model = I3D_ResNet_Non_Local(depth, num_classes=num_classes, dropout=dropout, without_t_stride=without_t_stride)
