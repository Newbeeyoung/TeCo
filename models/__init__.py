...
from models.threed_models.i3d_resnet import i3d_resnet,i3d_resnet_non_local,i3d_resnet_content,i3d_resnet_ttt

from models.twod_models.resnet import resnet,resnet_content,resnet_non_local
