from . import s3d, i3d, s3d_resnet, i3d_resnet, resnet,resnet_content,resnet_non_local, i3d_resnet_ttt,resnet_ttt, inception_v1,i3d_resnet_non_local,i3d_resnet_content
...
MODEL_TABLE = {
    ...
    'resnet': resnet,
    'resnet_content':resnet_content,
    'resnet_non_local': resnet_non_local,
    'resnet_ttt':resnet_ttt,
    'inception_v1': inception_v1,
    'i3d_resnet_non_local':i3d_resnet_non_local,
    'i3d_resnet_content':i3d_resnet_content,
    'i3d_resnet_ttt':i3d_resnet_ttt,
}
