...
def arg_parser():
    ...
    parser.add_argument('--data_folder',type=str,default='../Dataset/mini_kinetics200-c')
    ...
    parser.add_argument('--corruption',default='shot_noise',type=str,
    ...
    parser.add_argument('--name',default="",type=str,
                        help='name the validation folder')
    ...
    parser.add_argument('--beta', default=0.1, type=float, help='weigth of kl divergence')
    parser.add_argument('--ent', type=bool, default=True)
    parser.add_argument('--distance', default=1, type=int, help='frame distance for temporal consistency loss')
    parser.add_argument('--freeze_layer', type=int, default=4)
    parser.add_argument('--prior', default=1, type=float, help='propotion of test running mean/var in batch normalization')
